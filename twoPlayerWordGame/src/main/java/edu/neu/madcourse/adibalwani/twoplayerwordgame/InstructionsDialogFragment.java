...
public class InstructionsDialogFragment extends DialogFragment {
    ...
    /**
     * Create new instance of InstructionsDialogFragment, providing layoutId
     * as an argument
     *
     * @param layoutId The id of Layout to display in dialog
     * @return Instance of InstructionsDialogFragment
     */
    static InstructionsDialogFragment newInstance(int layoutId) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(view)
                .setPositiveButton(R.string.twoplayerwordgame_about_ok,

...
public class Tile {
    ...
    public void removeBackgroundDrawable() {
        ...
        Button button = (Button) mView;
        Drawable background = mGame.getResources().getDrawable(R.drawable.wordgame_tile_blank);
        ...
        switch (mState) {
            case SELECTED:
                if (phase == mGame.PHASE_1) {
                    background = mGame.getResources().getDrawable(R.drawable.wordgame_tile_selected);
                } else if (phase == mGame.PHASE_2 && mGrid != null && mGrid.isInactive()) {
                    background = mGame.getResources().getDrawable(R.drawable.wordgame_tile_inactive);
                } else if (phase == mGame.PHASE_2) {
                    background = mGame.getResources().getDrawable(R.drawable.wordgame_tile_unselected);
                }
                break;
            case UNSELECTED:
                background = mGame.getResources().getDrawable(R.drawable.wordgame_tile_unselected);
